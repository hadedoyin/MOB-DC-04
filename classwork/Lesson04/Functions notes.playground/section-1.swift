...
//optionals can be constants also

var name: String?
let age = 22

//using "!" generally means "override", so it takes away the "optional" thing
...
// 1 
//use the bang -> "!" to get rid of the "optional" thing next to the variable
// do not want to really use this method because if the variable has no value, then the program will crash
...
// 2
// with a tradtional if/else to see if value is nil or not (called "unwrapping")
...
// 3
// can store the optional in a constant -->
...
func sayHello() {
    ...
    print("Running function", terminator:"")
}
...
func sayHelloFirstNameLastName (firstName: String, lastName: String, age: Int) {
    
    print("Hi, \(firstName) - is \(lastName) your last name?", terminator: "")
    print("Great, I'm glad that that is your last name. Are you \(age) years old?", terminator: "")
}

sayHelloFirstNameLastName("Hezekiah", lastName: "Adedoyin", age: 22)


// use the "->" to expect a return value
func areaOfRectangle (height: Int, base: Int) -> Int {
    
    // use let instead of var when creating an instance variable
    let area: Int = base * height
//    print("Area = \(area)", terminator:"")
    return area
}

// returning lets you make things available outside function scope

var mySquare: Int = areaOfRectangle(20, base: 20)

var yourSquare: Int = areaOfRectangle(22, base: 22)


func displayArea (area: Int) {
    
    print("The area is \(area)", terminator:"")
}
